...
class SendEmailCaptchaSerializer(serializers.Serializer):
    ...
    """
    email = serializers.EmailField(max_length=254, validators=[email_validator, ])
...
class RegisterUserSerializer(serializers.ModelSerializer):
    ...
    captcha = serializers.CharField(write_only=True, validators=[captcha_validator,])
    class Meta:
        model = User
...
class ForgotPasswordSerializer(serializers.Serializer):
    email = serializers.EmailField(max_length=254, validators=[email_validator,])
    captcha = serializers.CharField(validators=[captcha_validator,])
    new_password = serializers.CharField(min_length=6, max_length=16, validators=[password_validator,])
...
class UpdateEmailSerializer(serializers.ModelSerializer):
    ...
    new_email = serializers.EmailField(max_length=254, validators=[email_validator,])
    captcha = serializers.CharField(validators=[captcha_validator,])
