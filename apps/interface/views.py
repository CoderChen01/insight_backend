    ...
    def post(self, request, *args, **kwargs):
        ...
        if not serializer.is_valid():
            ...
            if serializer.errors.get('ai_skill_group_id'):
                if serializer.errors['ai_skill_group_id'][0].code == 'required':
...
class UpdateInterfaceGroup(APIView):
    ...
    def patch(self, request, *args, **kwargs):
        ...
        ai_skill_group = ai_skill_groups.filter(ai_skill_group_id=ai_skill_group_id).first()
...
class RefreshState(APIView):
    ...
    def patch(self, request, *args, **kargs):
        ...
        try:
            ai_skill_test = requests.get(ai_skill.ai_skill_url, timeout=10).status_code
